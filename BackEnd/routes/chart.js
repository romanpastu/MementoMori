...
router.get('/pie/emotion', requireLogin, async (req, res) => {
 ...
 *        description: Various errors.
 */
router.get('/cumulative-maxpotential/emotion', requireLogin, async (req, res) => {
    const authorization = req.headers['authorization'];
    if (authorization == undefined) {
        res.send("provide a valid token")
    }
 ...
 *        description: Various errors.
 */
router.get('/cumulative/emotion', requireLogin, async (req, res) => {
    const authorization = req.headers['authorization'];
    if (authorization == undefined) {
      res.send("provide a valid token")
    }
 ...
 *        description: Various errors.
 */
router.get('/lineal/emotion', requireLogin, async (req, res) => {
    const authorization = req.headers['authorization'];
    if (authorization == undefined) {
      res.send("provide a valid token")
    }
